<div class="card-content">
    <div class="card-body">
        <form class="form form-vertical" method="post" action="{{route("sectiontabs.store")}}"
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class='form-check'>
                            <div class="mb-3">
                                <label for="formFileSm" class="form-label">Tab Resmi </label>
                                <input class="form-control form-control-sm" id="formFileSm" name="image" type="file"
                                       required>
                                <small style="color: red;font-weight: bold">Yanlızca 600X600 px ölçülerinde</small>
                            </div>
                        </div>
                    </div>
