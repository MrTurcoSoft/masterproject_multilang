...
@section('title',\SiteHelpers::ayar('mark').' | '.$product->page_title)
@section('keywords',$product->page_keywords)
...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12 align-self-center p-static order-2 text-center">
                            <div class="overflow-hidden pb-2">
                                <h1 class="text-dark font-weight-bold text-9 appear-animation"
                                    ...
                                    data-appear-animation-delay="100">{{ $product->name }} <br> {{ $product->title }}
                                </h1>
                            </div>
                        </div>
                        <div class="col-md-12 align-self-center order-1">
                            <ul class="breadcrumb d-block text-center appear-animation" data-appear-animation="fadeIn"
                                ...
                                <li><a href="{{getLocalizedUrl('home')}}">{{___("Home")}}</a></li>
                                <li><a href="{{getLocalizedUrl('category',['slug' =>$category->slug])}}">{{$category->cat_name}}</a></li>
    ...
    <div class="container pt-2 pb-4">
        ...
        <div class="row pb-4 mb-2">
            <div class="col-md-6 mb-4 mb-md-0 appear-animation" data-appear-animation="fadeInLeftShorter"
                ...
                <div
                    class="owl-carousel owl-theme nav-inside nav-inside-edge nav-squared nav-with-transparency nav-dark mt-3"
                ...
                <div class="appear-animation" data-appear-animation="fadeInRightShorter"
                    ...
                    <strong
                        class="text-uppercase text-1 me-3 text-dark float-start position-relative top-2">{{___("Share")}}</strong>
                    <!-- Sharingbutton Facebook -->
                    <a class="resp-sharing-button__link"
                       href="https://facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}" target="_blank"
                    ...
                    <a class="resp-sharing-button__link"
                       href="https://twitter.com/intent/tweet/?text=Elevate%20Your%20Hospitality%20Experience%20with%20Amenity%20Supply%3A%20Your%20Premier%20Partner%20for%20Quality%20Hotel%20Products&amp;url={{ urlencode(request()->url()) }}"
                    ...
                    <a class="resp-sharing-button__link"
                       href="https://www.tumblr.com/widgets/share/tool?posttype=link&amp;title=Elevate%20Your%20Hospitality%20Experience%20with%20Amenity%20Supply%3A%20Your%20Premier%20Partner%20for%20Quality%20Hotel%20Products&amp;caption=Elevate%20Your%20Hospitality%20Experience%20with%20Amenity%20Supply%3A%20Your%20Premier%20Partner%20for%20Quality%20Hotel%20Products&amp;content={{ urlencode(request()->url()) }}&amp;canonicalUrl={{ urlencode(request()->url()) }}&amp;shareSource=tumblr_share_button"
                       target="_blank" rel="noopener" aria-label="">
        ...
        <path
            d="M12,0C5.383,0,0,5.383,0,12s5.383,12,12,12s12-5.383,12-12S18.617,0,12,0z M15.492,17.616C11.401,19.544,9.5,17,9.5,14.031 V9.5h-2V8.142c0.549-0.178,1.236-0.435,1.627-0.768c0.393-0.334,0.707-0.733,0.943-1.2c0.238-0.467,0.401-0.954,0.49-1.675H12.5v3h2 v2h-2v3.719c0,2.468,1.484,2.692,2.992,1.701V17.616z"/>
                    ...
                    <a class="resp-sharing-button__link"
                       href="mailto:?subject=Elevate%20Your%20Hospitality%20Experience%20with%20Amenity%20Supply%3A%20Your%20Premier%20Partner%20for%20Quality%20Hotel%20Products&amp;body={{ urlencode(request()->url()) }}"
                    ...
                    <a class="resp-sharing-button__link"
                       href="https://pinterest.com/pin/create/button/?url={{ urlencode(request()->url()) }}&amp;media={{ urlencode(request()->url()) }}&amp;description=Elevate%20Your%20Hospitality%20Experience%20with%20Amenity%20Supply%3A%20Your%20Premier%20Partner%20for%20Quality%20Hotel%20Products"
                       target="_blank" rel="noopener" aria-label="">
        ...
        <path
            d="M12,0C5.383,0,0,5.383,0,12s5.383,12,12,12s12-5.383,12-12S18.617,0,12,0z M9.5,16.5h-2v-7h2V16.5z M8.5,7.5 c-0.553,0-1-0.448-1-1c0-0.552,0.447-1,1-1s1,0.448,1,1C9.5,7.052,9.053,7.5,8.5,7.5z M18.5,16.5h-3V13c0-0.277-0.225-0.5-0.5-0.5 c-0.276,0-0.5,0.223-0.5,0.5v3.5h-3c0,0,0.031-6.478,0-7h3v0.835c0,0,0.457-0.753,1.707-0.753c1.55,0,2.293,1.12,2.293,3.296V16.5z"/>
                    ...
                    <a class="resp-sharing-button__link"
                       href="whatsapp://send?text=Elevate%20Your%20Hospitality%20Experience%20with%20Amenity%20Supply%3A%20Your%20Premier%20Partner%20for%20Quality%20Hotel%20Products%20{{ urlencode(request()->url()) }}"
                       target="_blank" rel="noopener" aria-label="">
                    ...
                    <a class="resp-sharing-button__link"
                       href="https://telegram.me/share/url?text=Elevate%20Your%20Hospitality%20Experience%20with%20Amenity%20Supply%3A%20Your%20Premier%20Partner%20for%20Quality%20Hotel%20Products&amp;url={{ urlencode(request()->url()) }}"
                       target="_blank" rel="noopener" aria-label="">
            ...
            <div class="col-md-6">
                <div class="overflow-hidden">
                    ...
                    <h2 class="text-color-dark font-weight-normal text-4 mb-0 appear-animation"
                        data-appear-animation="maskUp" data-appear-animation-delay="600">{{___("Product")}} <strong
                            class="font-weight-extra-bold">{{___("Description")}}</strong></h2>
                </div>
                ...
                <div class="overflow-hidden mt-4">
                    <h2 class="text-color-dark font-weight-normal text-4 mb-0 appear-animation"
                        data-appear-animation="maskUp" data-appear-animation-delay="1000">{{___("Product")}} <strong
                            class="font-weight-extra-bold">{{___("Spesifications")}}</strong></h2>
                </div>
                <ul class="list list-icons list-primary list-borders text-2 appear-animation"
                    ...
                    <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">{{___("Volume/Pack
                            Of:")}}</strong> {{$product->detay->volume}}</li>
                    <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Box
                            Sizes:</strong> {{$product->detay->boxsize}}</li>
                    <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Quantity in
                            Box:</strong> {{$product->detay->qtyBox}}</li>
                    <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Box Net
                            Weight:</strong> {{$product->detay->BoxNetW}}</li>
                    <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Box Gross
                            Weight:</strong> {{$product->detay->BoxGrossW}}</li>
                    <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Boxes on
                            Pallet:</strong> {{$product->detay->BoxOnPallet}}</li>
                    <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">HS
                            CODE:</strong> {{$product->detay->hsCode}}</li>
                    <li><i class="fas fa-caret-right left-10"></i> <strong
                            class="text-color-primary">BARCODE:</strong> {{$product->detay->barcode}}</li>
                </ul>
            </div>
        </div>
    ...
    <section class="section section-height-3 bg-color-grey m-0 border-0 appear-animation" data-appear-animation="fadeIn"
