...
@section('title',SiteHelpers::ayar('author').' | Blog Yazısı Düzenle ')
@section('page-css')
    <!-- Dropify css -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Blog Yazısı Düzenle</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <form class="form form-vertical" method="post"
                                      action="{{route("posts.update",$value->id)}}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
