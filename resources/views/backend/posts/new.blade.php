...
@section('title',siteAyar('author').' | Yeni Blog Yazısı ')
@section('page-css')
    <!-- Dropify css -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Yeni Blog Yazısı</h4>
            ...
            <div class="col-xl-12">
                <div class="card card-animate">
                    <div class="card-body">
                        <h4 class="card-title">Yeni Blog Yazısı</h4>
                            ...
                            <div class="col-sm-8">
                                <form class="form form-vertical" method="post"
                                    ...
                                    <div class="card-body col-sm-6 mb-5">
                                        <h4 class="card-title">Post Resmi</h4>
                                        <p class="card-subtitle mb-4" style="color: red;font-weight: bold">Yanlızca 1200x500 px ölçülerinde</p>
                                        <input type="file"
                                    ...
                                    <div class="d-flex mt-3" style="gap: 20px;">
                                        ...
                                        <div class="tab-content flex-fill" id="v-pills-tabContent-right">
                                            ...
                                            @include('backend.posts.en-tab')
                                            <!-- Almanca Dil Dosyaları -->
                                            @include('backend.posts.de-tab')
                                            <!-- İspanyolca Dil Dosyaları -->
                                            @include('backend.posts.es-tab')
                                            <!-- Fransızca Dil Dosyaları -->
                                            @include('backend.posts.fr-tab')
                                            <!-- Macarca Dil Dosyaları -->
                                            @include('backend.posts.hu-tab')
                                            <!-- İtalyanca Dil Dosyaları -->
                                            @include('backend.posts.it-tab')
                                            <!-- Sırpça Dil Dosyaları -->
                                            @include('backend.posts.sr-tab')
                                        </div>
