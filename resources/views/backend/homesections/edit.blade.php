...
@section('title',SiteHelpers::ayar('author').' | Bölüm Düzenle ')
@section('page-css')
    <!-- Dropify css -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Bölüm Düzenle</h4>
            ...
            <div class="col-xl-12">
                <div class="card card-animate">
                    <div class="card-body">
                        <h4 class="card-title">Bölüm Düzenle</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <form class="form form-vertical" method="post"
                                      action="{{route("homesections.update",$value->id)}}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    @if($section==2)
                                    <div class="card-body col-sm-6 mb-5">
                                        <h4 class="card-title">Bölüm 2 Resmi</h4>
                                        <p class="card-subtitle mb-4" style="color: red;font-weight: bold">Yanlızca 1000X1000 px ölçülerinde</p>
                                        <input type="file"
                                               class="dropify" name="image"
                                               data-max-file-size="2M"
                                               data-default-file="{{ asset($value->image) }}"/>
                                    </div>
                                        <input type="hidden" name="section" value="2"><!-- end card-body-->
                                    @endif
                                    @if($section==4)
                                        <div class="card-body col-sm-6 mb-5">
                                            <h4 class="card-title">Bölüm 4 Resmi</h4>
                                            <p class="card-subtitle mb-4" style="color: red;font-weight: bold">Yanlızca 2000X2000 px ölçülerinde</p>
                                            <input type="file"
                                                   class="dropify" name="image"
                                                   data-max-file-size="2M"
                                                   data-default-file="{{ asset($value->image) }}"/>
                                    ...
                                    <div class="d-flex mt-3" style="gap: 20px;">
                                        ...
                                        <div class="tab-content flex-fill" id="v-pills-tabContent-right">
                                            ...
                                            @include('backend.homesections.en-tab')
                                            <!-- Almanca Dil Dosyaları -->
                                            @include('backend.homesections.de-tab')
                                            <!-- İspanyolca Dil Dosyaları -->
                                            @include('backend.homesections.es-tab')
                                            <!-- Fransızca Dil Dosyaları -->
                                            @include('backend.homesections.fr-tab')
                                            <!-- Macarca Dil Dosyaları -->
                                            @include('backend.homesections.hu-tab')
                                            <!-- İtalyanca Dil Dosyaları -->
                                            @include('backend.homesections.it-tab')
                                            <!-- Sırpça Dil Dosyaları -->
                                            @include('backend.homesections.sr-tab')
                                        </div>
