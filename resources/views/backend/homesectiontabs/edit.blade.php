...
@section('title',SiteHelpers::ayar('author').' | Tab Düzenle ')
@section('page-css')
    <!-- Dropify css -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Tab Düzenle</h4>
            ...
            <div class="col-xl-12">
                <div class="card card-animate">
                    <div class="card-body">
                        <h4 class="card-title">Tab Düzenle</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <form class="form form-vertical" method="post"
                                      action="{{route("sectiontabs.update",$value->id)}}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf

                                    <div class="card-body col-sm-6 mb-5">
                                        <h4 class="card-title">Tab Resmi</h4>
                                        <p class="card-subtitle mb-4" style="color: red;font-weight: bold">Yanlızca 600x600 px ölçülerinde</p>
                                        <input type="file"
                                    ...
                                    <div class="d-flex mt-3" style="gap: 20px;">
                                        ...
                                        <div class="tab-content flex-fill" id="v-pills-tabContent-right">
                                            ...
                                            @include('backend.homesectiontabs.en-tab')
                                            <!-- Almanca Dil Dosyaları -->
                                            @include('backend.homesectiontabs.de-tab')
                                            <!-- İspanyolca Dil Dosyaları -->
                                            @include('backend.homesectiontabs.es-tab')
                                            <!-- Fransızca Dil Dosyaları -->
                                            @include('backend.homesectiontabs.fr-tab')
                                            <!-- Macarca Dil Dosyaları -->
                                            @include('backend.homesectiontabs.hu-tab')
                                            <!-- İtalyanca Dil Dosyaları -->
                                            @include('backend.homesectiontabs.it-tab')
                                            <!-- Sırpça Dil Dosyaları -->
                                            @include('backend.homesectiontabs.sr-tab')
                                        </div>
