...
@section('title',SiteHelpers::ayar('author').' | Yeni Slider ')
@section('page-css')
    <!-- Dropify css -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Yeni Slider</h4>
            ...
            <div class="col-xl-12">
                <div class="card card-animate">
                    <div class="card-body">
                        <h4 class="card-title">Yeni Slider</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <form class="form form-vertical" method="post"
                                      action="{{route("slider-management.store")}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-switch">
                                            ...
                                            <input type="checkbox" data-toggle="switchery" data-color="#38b3d6" name="isActive" data-secondary-color="#df3554" value="1" checked/>
