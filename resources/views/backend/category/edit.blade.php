...
@section('title',SiteHelpers::ayar('author').' | Kategori Düzenle ')
@section('page-css')
    <!-- Dropify css -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <form class="form form-vertical" method="post"
                                      action="{{route("categories.update",$value->id)}}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="ust_id" class="form-control" data-toggle="select2">
                                                ...
                                                <option value="null" {{$value->ust_id == null ? 'selected' : null}}>Ana Kategori</option>
                                                @foreach ($categories as $cat)
                                                    <option  value="{{ $cat->id }}" {{$value->ust_id == $cat->id ? 'selected' : null}}>
                                                        {{ $cat->cat_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" data-toggle="touchspin" name="must"
                                                   value="{{ old('must', $value->must ) }}" required>
                                        </div>
                                    </div>
