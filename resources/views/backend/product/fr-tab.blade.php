<div class="tab-pane fade" id="fr" role="tabpanel" aria-labelledby="fr">
    ...
    <div class="form-group">
        <label for="name_fr">Ürün Adı</label>
        <input type="text" id="name_fr" class="form-control" name="name_fr"
               placeholder="Ürün adı alanını doldurunuz"
               value="{{ old('name_fr')?: (isset($value) ? $value->name_fr : '') }}">
    ...
    <div class="form-group">
        ...
        <input type="text" id="title_fr" class="form-control" name="title_fr"
               ...
               value="{{ old('title_fr')?: (isset($value) ? $value->title_fr : '') }}">
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
    ...
    <div class="form-group">
        ...
        <textarea id="description_fr" class="tinymce-editor"
                  name="description_fr">{!! old('description_fr')?: (isset($value) ? $value->description_fr : '') !!}</textarea>
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
