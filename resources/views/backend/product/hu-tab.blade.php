<div class="tab-pane fade" id="hu" role="tabpanel" aria-labelledby="hu">
    <div class="form-group">
        <label for="name_hu">Ürün Adı</label>
        <input type="text" id="name_hu" class="form-control" name="name_hu"
               placeholder="Ürün adı alanını doldurunuz"
               value="{{ old('name_hu')?: (isset($value) ? $value->name_hu : '') }}">
    ...
    <div class="form-group">
        ...
        <input type="text" id="title_hu" class="form-control" name="title_hu"
               ...
               value="{{ old('title_hu')?: (isset($value) ? $value->title_hu : '') }}">
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
    ...
    <div class="form-group">
        ...
        <textarea id="description_hu" class="tinymce-editor"
                  name="description_hu">{!! old('description_hu')?: (isset($value) ? $value->description_hu : '') !!}</textarea>
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
    ...
    <div class="form-group">
        ...
        <input type="text" id="page_title_hu" class="form-control"
               ...
               value="{{ old('page_title_hu')?: (isset($value) ? $value->page_title_hu : '') }}">
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="page_description_hu"
                  ...
                  rows="5">{{ old('page_description_hu')?: (isset($value) ? $value->page_description_hu : '') }}</textarea>
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
    ...
    <div class="form-group">
        ...
        <input type="text" id="page_keywords_hu" class="form-control"
               ...
               value="{{ old('page_keywords_hu')?: (isset($value) ? $value->page_keywords_hu : '') }}">
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
    ...
    <div class="form-group">
        ...
        <input type="text" id="simpleinput" class="form-control" name="slug_hu"
               ...
               value="{{ old('slug_hu')?: (isset($value) ? $value->slug_hu : '') }}">
    </div>
</div>
