<div class="tab-pane fade" id="sr" role="tabpanel" aria-labelledby="sr">
    <div class="form-group">
        ...
        <input type="text" id="name_sr" class="form-control" name="name_sr"
               placeholder="Ürün adı alanını doldurunuz"
               value="{{ old('name_sr')?: (isset($value) ? $value->name_sr : '') }}">
    ...
    <div class="form-group">
        ...
        <input type="text" id="title_sr" class="form-control" name="title_sr"
               ...
               value="{{ old('title_sr')?: (isset($value) ? $value->title_sr : '') }}">
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
    ...
    <div class="form-group">
        ...
        <textarea id="description_sr" class="tinymce-editor"
                  name="description_sr">{!! old('description_sr')?: (isset($value) ? $value->description_sr : '') !!}</textarea>
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
