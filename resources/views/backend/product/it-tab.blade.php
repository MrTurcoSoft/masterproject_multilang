<div class="tab-pane fade" id="it" role="tabpanel" aria-labelledby="it">
    <div class="form-group">
        <label for="name_it">Ürün Adı</label>
        <input type="text" id="name_it" class="form-control" name="name_it"
               placeholder="Ürün adı alanını doldurunuz"
               value="{{ old('name_it')?: (isset($value) ? $value->name_it : '') }}">
    ...
    <div class="form-group">
        ...
        <input type="text" id="title_it" class="form-control" name="title_it"
               ...
               value="{{ old('title_it')?: (isset($value) ? $value->title_it : '') }}">
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
    ...
    <div class="form-group">
        ...
        <textarea id="description_it" class="tinymce-editor"
                  name="description_it">{!! old('description_it')?: (isset($value) ? $value->description_it : '') !!}</textarea>
        <button type="button" class="btn btn-secondary translate-btn d-flex align-items-center"
